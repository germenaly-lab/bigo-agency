...
export const defaultAgencyManagementItems = [
  ...
  },
  {
    ...
    icon: 'Smartphone',
    color: '#8b5cf6',
    shortDesc: 'أبرز مميزات وفرص منصة Bigo Live العالمية لصناع المحتوى والبث المباشر',
    details: [
      'وصول عالمي فوري لأكثر من 400 مليون مستخدم نشط وقاعدة كبار داعمين.',
      'أعلى عوائد ربحية وسرعة تحويل الفاصوليا والهدايا إلى أرباح نقدية حقيقية.',
      'أنظمة منافسة متطورة وباتلات (PK Battles) رسمية ترفع شهرة المذيع وتضاعف أرباحه.',
      'تقنيات بث فائقة الجودة بدقة 1080p Full HD مع فلاتر ومؤثرات تفاعلية حديثة.',
      'مسابقات وفعاليات كبرى بجوائز مالية ضخمة ودعوات حضور لحفل GALA السنوي.',
      'حماية أمنية مشددة للحسابات ونظام تحقق بيومتري لحماية الأرباح والمحافظ.'
    ]
  },
  {
    id: 'agency-features',
