...
export const defaultAgencyManagementItems = [
  ...
  },
  {
    ...
    icon: 'Award',
    color: '#f59e0b',
    shortDesc: 'المزايا الحصرية والخدمات الإدارية والدعم المالي المخصص لمذيعي وكالة سكوب',
    details: [
      'عقود رسمية معتمدة تضمن حقوق المذيع مع نسب أرباح تصاعدية وبونص إضافي.',
      'دعم فني وإداري مخصص 24/7 لحل كافة المشكلات التقنية وتوثيق الحسابات.',
      'ترشيح وتصعيد المذيعين للظهور في قوائم الترند وبانرات الصفحة الأولى.',
      'سحب وصرف فوري للأرباح والفاصوليا دون تأخير وبأفضل أسعار الصرف المحلية والدولية.',
      'برامج تدريبية لتطوير كواليتي البث، اختيار المحتوى، وفنون التعامل مع الداعمين.',
      'دعم نقاط الوكالة في الباتلات والتحديات الكبرى لمساعدة مذيعينا على تصدر المراكز الأولى.'
    ]
  }
];
