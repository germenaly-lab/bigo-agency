...
export const defaultAgencyManagementItems = [
  {
    ...
    icon: 'UserPlus',
    color: '#06b6d4',
    shortDesc: 'يمكنك تسجيل صناع المحتوى من خلال النظام باستخدام الخطوات التالية',
    details: [
  ...
  {
    id: 'app-features',
    title: 'مميزات الابلكيشن',
    badge: 'بيجو لايف الرسمي',
    icon: 'Smartphone',
    color: '#8b5cf6',
    shortDesc: 'مميزات الابلكيشن بقا الي بنقدمو ليك 💸📱',
    details: [
      'ابلكيشن من اقدم برامج اللايف استريم يعني موثوق ومضمون 100% 💯',
      'اي دعم بينزلك بتستفيد منه مرتين مره سحب فوري ومره نسبه عالتارجت شهري او اسبوعي 💸',
      'خصوصيه تامه ع الابلكيشن لو مش حابب حد يعرف بتعمل فلوس منين 💰',
      'الابلكيشن عليه مذيعين من جميع انحاء الشرق الاوسط يعني تقدر تزود دايره صحابك 🥰',
      'الابلكيشن فيه فلاتر لذيذه بتساعدك ان كواليتي اللايف يبقا اعلي 💫',
      'الاعدادات بتاعت البرنامج بتخليك تقدر تتحكم ف كل حاجه يعني مفيش اي حاجه مفروضه عليك ✌🏻',
      'من سياسات التطبيق ممنوع الكلام في السياسه & وفالدين & والجنس ❌'
    ]
  },
  {
    id: 'agency-features',
    title: 'مميزات الوكاله',
    badge: 'وكالة سكوب المعتمدة',
    icon: 'Award',
    color: '#f59e0b',
    shortDesc: 'الوكاله بتساعدك كتير و من مميزتها ✨',
    details: [
      'مسئول متابعه معاك بشكل يومي بيساعدك في اي حاجه تخص لايفك 🙋🏻‍♂️',
...
export const defaultPointsUsageItems = [
  {
    id: 'social-promo',
    title: 'طلب الترويج للوكالة عبر حساباتنا في منصات التواصل الاجتماعي',
    pointsCost: '150 - 500 نقطة',
    points: '150 - 500',
    icon: 'Globe',
    color: '#3b82f6',
    desc: 'الترويج لحساب وفعاليات الوكالة عبر المنصات الرسمية لجذب أكبر عدد من المتابعين والداعمين.'
  },
  {
    id: 'assistants-badge',
    title: 'طلب شارة الوكالة الرسمية للمساعدين',
    pointsCost: '100 نقطة',
    points: '100',
    icon: 'Award',
    color: '#8b5cf6',
    desc: 'منح شارة الوكالة الحصرية والمميزة لمساعدي ومشرفي الرومات لتمييزهم رسمياً داخل التطبيق.'
  },
  {
    id: 'stream-protection',
    title: 'طلب حماية البث من تعليقات الحسابات الصغيرة',
    pointsCost: '50 نقطة',
    points: '50',
    icon: 'ShieldCheck',
    color: '#10b981',
    desc: 'تفعيل نظام الحماية التلقائي للبث لمنع تعليقات السبام وإزعاج الحسابات الوهمية والصغيرة.'
  },
  {
    id: 'level-boost',
    title: 'طلب زيادة مستوى الحساب 30% لمدة يوم واحد',
    pointsCost: '350 نقطة',
    points: '350',
    icon: 'TrendingUp',
    color: '#f59e0b',
    desc: 'زيادة مستوى ولفل الحساب بنسبة 30% لمدة 24 ساعة لرفع قوة وتصنيف الحساب في المنصة.'
  },
  {
    id: 'promising-creators',
    title: 'طلب قائمة صناع المحتوى الواعدين',
    pointsCost: '150 نقطة',
    points: '150',
    icon: 'Users',
    color: '#06b6d4',
    desc: 'الحصول على قائمة منتقاة لأبرز المواهب وصناع المحتوى الصاعدين لضمهم واستقطابهم لوكالتك.'
  },
  {
    id: 'newsletter-promo',
    title: 'طلب ترويج لصانع محتوى عبر رسالة اخبارية',
    pointsCost: '150 نقطة',
    points: '150',
    icon: 'Mail',
    color: '#ec4899',
    desc: 'إرسال رسالة إخبارية ترويجية داخل التطبيق لتسليط الضوء على المذيع وتوسيع قاعدة جماهيره.'
  },
  {
    id: 'push-notification',
    title: 'طلب ترويج لصانع محتوى عبر رسالة بوش',
    pointsCost: '300 نقطة',
    points: '300',
    icon: 'Bell',
    color: '#f97316',
    desc: 'إرسال إشعار بوش (Push Notification) جماعي مباشر على هواتف المستخدمين عند فتح اللايف.'
  },
  {
    id: 'share-for-all',
    title: 'طلب خاصية المشاركة للجميع',
    pointsCost: '100 نقطة',
    points: '100',
    icon: 'Send',
    color: '#14b8a6',
    desc: 'تفعيل ميزة مشاركة رابط البث على نطاق واسع لجميع المستخدمين لزيادة الحضور والمشاهدات.'
  },
  {
    id: 'unban-standard',
    title: 'طلب فك الحظر',
    ...
    icon: 'ShieldAlert',
    color: '#6366f1',
    desc: 'تقديم طلب رسمي لفك الحظر عن الحسابات المقيدة ومراجعة المخالفات لدى الإدارة الرسمية.'
  },
  {
    id: 'unban-urgent',
    title: 'طلب فك حظر مستعجل',
    pointsCost: '100 - 250 نقطة',
    points: '100 - 250',
    icon: 'Zap',
    color: '#ef4444',
    desc: 'معالجة فورية ومستعجلة عبر خط تواصل مباشر لفك حظر الحسابات المقيدة في أسرع وقت.'
  },
  {
    id: 'creator-trend',
    title: 'طلب ترند لصانع محتوى معين',
    pointsCost: '100 نقطة',
    points: '100',
    icon: 'Flame',
    color: '#e11d48',
    desc: 'وضع صانع المحتوى في صدارة قائمة الترند لزيادة عدد المتابعين والمشاهدات بشكل قياسي.'
  }
];
...
export const defaultBeanWithdrawalItems = [
  {
    id: 'agent-recharge',
    title: 'السحب عبر وكيل الشحن المعتمد (Distributor Channel)',
    category: 'الخيار الوحيد والمعتمد',
    icon: 'RefreshCw',
    color: '#8b5cf6',
    features: [
      'تنفيذ فوري للسحب عبر قناة الموزع الرسمية (Distributor Channel: Scoop Agency)',
      'سحب الفاصوليا بأعلى سعر صرف موجود في السوق (على حسب سعر الدولار يوم السحب)',
      'استلام نقدي فوري أو عبر المحافظ الإلكترونية المحلية والحسابات المعتمدة',
      'دعم ومتابعة فورية على مدار 24 ساعة لضمان أمان العمليات'
    ]
  }
];
